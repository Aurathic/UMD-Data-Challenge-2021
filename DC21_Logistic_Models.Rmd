...
Sex_outside <- Sex %>%
  ...
  labs(x = 'Gender', y= 'Percentage of Respondents', title = 'Men vs Non-Essential Excursions') +
  scale_y_continuous(labels = scales::label_percent()) +
  scale_fill_brewer(palette = "Set1", name = 'Went out for reasons besides grocery shopping/exercise') +
  theme_classic() +
...
Educ_outside <- Educ %>%
  ggplot(aes(fill=Outside_Ac_or_not, y=number_of_respondents, x=Educ)) + 
    geom_bar(position="fill", stat="identity", width = 0.8, alpha = 0.8) + 
  labs(x = 'Education Level', y= 'Percentage of Respondents', title = 'College \\ Associate\'s Degree vs Non-Essential Excursions') +
  scale_y_continuous(labels = scales::label_percent()) +
  scale_fill_brewer(palette = "Set1", name = 'Went out for reasons besides grocery shopping/exercise') +
  theme_classic() +
  theme(axis.ticks = element_blank(),
...
Htype_outside <- Htype %>%
  ...
  geom_bar(position="fill", stat="identity", width = 0.8, alpha = 0.8) + 
  labs(x = 'Household Type', y= 'Percentage of Respondents', title = 'People in Multi-Family Homes vs Non-Essential Excursions') +
  scale_y_continuous(labels = scales::label_percent()) +
  scale_fill_brewer(palette = "Set1", name = 'Went out for reasons besides grocery shopping/exercise') +
  theme_classic() +
  theme(axis.ticks = element_blank(),
